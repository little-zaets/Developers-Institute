...
SELECT customer.first_name, customer.last_name, address.address, address.phone FROM address
...
SELECT payment.amount, payment.payment_date FROM payment 
